return {
  ...
  keys = {
    ...
    { "<leader>'", LazyVim.pick("grep_string", { word_match = "-w" }), desc = "Word (Root Dir)" },
    { "<leader>'", LazyVim.pick("grep_string"), mode = "v", desc = "Selection (Root Dir)" },
    { "<leader>`", LazyVim.pick("colorscheme", { enable_preview = true }), desc = "Colorscheme with Preview" },
  },
  opts = function()
